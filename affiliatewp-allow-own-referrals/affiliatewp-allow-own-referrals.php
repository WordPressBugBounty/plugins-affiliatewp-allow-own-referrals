 ...
 * Version: 1.2.1
 * Text Domain: affiliatewp-allow-own-referrals
 *
 ...
 *
 * @package AffiliateWP - Allow Own Referrals
 * @category Core
 */
 ...
 */
class AffiliateWP_AOR_Requirements_Check extends AffiliateWP_Requirements_Check_v1_1 {
	 ...
	 * @var   string
	 */
	protected $slug = 'affiliatewp-allow-own-referrals';
	...
	public function bootstrap() {
		if ( ! class_exists( 'Affiliate_WP' ) ) {
			...
			\AffiliateWP_Allow_Own_Referrals::instance( __FILE__ );
		}
	}
	...
	protected function load() {
		...
		if ( ! class_exists( 'AffiliateWP_Allow_Own_Referrals' ) ) {
			require_once dirname( __FILE__ ) . '/includes/class-affiliatewp-allow-own-referrals.php';
		}
	...
	public function install() {
		...
		if ( defined( 'AFFWP_AOR_VERSION' ) ) {
			update_option( 'affwp_aor_version', AFFWP_AOR_VERSION );
		}
	}
...
$requirements = new AffiliateWP_AOR_Requirements_Check( __FILE__ );
